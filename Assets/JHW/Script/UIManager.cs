...
public class UIManager : SingletonMonoBehaviour<UIManager>
{
    ...
    private void Start() {
        ...
        this.transform.GetChild(2).GetChild(0).GetComponent<Button>().onClick.AddListener(()=>gm.GameRestart()); // °ÔÀÓÀç½ÃÀÛ
        this.transform.GetChild(2).GetChild(1).GetComponent<Button>().onClick.AddListener(() => this.Btn_ToMain()); // ¸ÞÀÎÈ­¸é
    }
    ...
    public void UI_GameStart()
    {
        ...
        UI_changeBullet(); // ÃÑ¾Ë °³¼öUI º¯°æ
        UI_changeFragment(); // Á¶°¢ °³¼öUI º¯°æ
    }
